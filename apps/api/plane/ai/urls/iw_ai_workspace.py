# InfraWatch — workspace AI URL patterns
# Mounted at: api/workspaces/<slug>/ai/  (via plane.app.urls.iw_workspace_ai)
# SPDX-License-Identifier: AGPL-3.0-only

from django.urls import path

from plane.iw.views.iw_ai_workspace import (
...
urlpatterns = [
    # Settings (singleton per workspace)
    path(
        "settings/",
